...
order: 4
description: What it is like to work in a Web3 world
tag: fast-track
---
...
* **Trigger event:** WHEN A produces 100x Units, THEN B collects and delivers.
...
Whether a person is employed by a conventional company, is a freelancer, a member of a DAO, or is simply an engaged participant, some general observations can be made about working in the Web3 environment:

* There is lots of innovation – blockchain technology enables teams to build projects that have never been done before.
* There is an extremely broad range of use cases, from purely financial to environmental activism projects.
...
* Lots of projects fail – it is easy for anyone to get involved, which can result in inexperienced teams working with a complex, still emerging technology.
* The environment is both fast-paced and potentially chaotic – legislation changes, can be inconsistent, or even non-existent in different regions and there is a lot of market volatility.

Some additional factors are worth looking at in a little more detail.
...
In the [next section](ADD LINK HERE), the focus narrows to discuss a few specific problems that blockchain was designed to solve, and then examines a key issue for distributed networks: *how to ensure confidentiality in a shared ledger*.
